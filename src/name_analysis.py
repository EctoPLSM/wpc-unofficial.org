...
from database_participants import database as db
from database_participants import year_grouped as dby
from database_participants import code_grouped as dbc
